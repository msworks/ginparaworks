...
public class MainLogic : MonoBehaviour {
    ...
    List<structReachPattern> reachPattern123 = new List<structReachPattern>
    {
        ...
        new structReachPattern{ No= 5, Chusenti=0, Name="泡+SP3" },
        new structReachPattern{ No= 6, Chusenti=800, Name="魚群+SP1" },
        new structReachPattern{ No= 7, Chusenti=736, Name="魚群+SP2" },
        new structReachPattern{ No= 8, Chusenti=0, Name="魚群+SP3" },
        new structReachPattern{ No= 9, Chusenti=0, Name="ノーマル" },
        new structReachPattern{ No= 10, Chusenti=0, Name="ノーマル＋再始動（+1）" },
        new structReachPattern{ No= 11, Chusenti=0, Name="ノーマル＋再始動（+2）" },
        new structReachPattern{ No= 12, Chusenti=0, Name="ノーマル＋再始動（+3）" },
        new structReachPattern{ No= 13, Chusenti=0, Name="ノーマル＋再始動（+4）" },
        new structReachPattern{ No= 14, Chusenti=0, Name="ノーマル＋再始動（+5）" },
        new structReachPattern{ No= 15, Chusenti=0, Name="ノーマル＋再始動（+6）" },
        new structReachPattern{ No= 16, Chusenti=0, Name="ノーマル＋再始動（+7）" },
        new structReachPattern{ No= 17, Chusenti=0, Name="ノーマル＋再始動（+8）" },
        new structReachPattern{ No= 18, Chusenti=0, Name="ノーマル＋再始動（+9）" },
        new structReachPattern{ No= 19, Chusenti=0, Name="ノーマル＋再始動（+10）" },
        new structReachPattern{ No= 20, Chusenti=0, Name="ノーマル＋再始動（+11）" },
        new structReachPattern{ No= 21, Chusenti=0, Name="ノーマル＋再始動（+12）" },
        new structReachPattern{ No= 22, Chusenti=0, Name="ノーマル＋再始動（+13）" },
        new structReachPattern{ No= 23, Chusenti=0, Name="ノーマル＋再始動（+14）" },
        new structReachPattern{ No= 24, Chusenti=0, Name="ノーマル＋再始動（+15）" },
        new structReachPattern{ No= 25, Chusenti=0, Name="ノーマル＋再始動（+16）" },
        new structReachPattern{ No= 26, Chusenti=0, Name="ノーマル＋再始動（+17）" },
        new structReachPattern{ No= 27, Chusenti=0, Name="ノーマル＋再始動（+18）" },
        new structReachPattern{ No= 28, Chusenti=0, Name="ノーマル＋再始動（+19）" },
        new structReachPattern{ No= 29, Chusenti=0, Name="ノーマル＋再始動（+20）" },
        new structReachPattern{ No= 30, Chusenti=0, Name="泡+ノーマル" },
        new structReachPattern{ No= 31, Chusenti=0, Name="泡＋ノーマル＋再始動（+1）" },
        new structReachPattern{ No= 32, Chusenti=0, Name="泡＋ノーマル＋再始動（+2）" },
        new structReachPattern{ No= 33, Chusenti=0, Name="泡＋ノーマル＋再始動（+3）" },
        new structReachPattern{ No= 34, Chusenti=0, Name="泡＋ノーマル＋再始動（+4）" },
        new structReachPattern{ No= 35, Chusenti=0, Name="泡＋ノーマル＋再始動（+5）" },
        new structReachPattern{ No= 36, Chusenti=0, Name="泡＋ノーマル＋再始動（+6）" },
        new structReachPattern{ No= 37, Chusenti=0, Name="泡＋ノーマル＋再始動（+7）" },
        new structReachPattern{ No= 38, Chusenti=0, Name="泡＋ノーマル＋再始動（+8）" },
        new structReachPattern{ No= 39, Chusenti=0, Name="泡＋ノーマル＋再始動（+9）" },
        new structReachPattern{ No= 40, Chusenti=0, Name="泡＋ノーマル＋再始動（+10）" },
        new structReachPattern{ No= 41, Chusenti=0, Name="泡＋ノーマル＋再始動（+11）" },
        new structReachPattern{ No= 42, Chusenti=0, Name="泡＋ノーマル＋再始動（+12）" },
        new structReachPattern{ No= 43, Chusenti=0, Name="泡＋ノーマル＋再始動（+13）" },
        new structReachPattern{ No= 44, Chusenti=0, Name="泡＋ノーマル＋再始動（+14）" },
        new structReachPattern{ No= 45, Chusenti=0, Name="泡＋ノーマル＋再始動（+15）" },
        new structReachPattern{ No= 46, Chusenti=0, Name="泡＋ノーマル＋再始動（+16）" },
        new structReachPattern{ No= 47, Chusenti=0, Name="泡＋ノーマル＋再始動（+17）" },
        new structReachPattern{ No= 48, Chusenti=0, Name="泡＋ノーマル＋再始動（+18）" },
        new structReachPattern{ No= 49, Chusenti=0, Name="泡＋ノーマル＋再始動（+19）" },
        new structReachPattern{ No= 50, Chusenti=0, Name="泡＋ノーマル＋再始動（+20）" },
        ...
        new structReachPattern{ No= 55, Chusenti=0, Name="泡＋SP3（0）" },
        new structReachPattern{ No= 56, Chusenti=0, Name="泡＋SP3（+1⇒戻り）" },
        new structReachPattern{ No= 57, Chusenti=0, Name="泡＋SP3（+2）" },
        new structReachPattern{ No= 58, Chusenti=0, Name="泡＋SP3（+3⇒戻り）" },
        new structReachPattern{ No= 59, Chusenti=0, Name="魚群＋SP1（0）" },
        new structReachPattern{ No= 60, Chusenti=0, Name="魚群＋SP1（+1⇒戻り）" },
        new structReachPattern{ No= 61, Chusenti=0, Name="魚群＋SP2（0）" },
        new structReachPattern{ No= 62, Chusenti=0, Name="魚群＋SP2（+1⇒戻り）" },
        new structReachPattern{ No= 63, Chusenti=0, Name="魚群＋SP3（0）" },
        new structReachPattern{ No= 64, Chusenti=0, Name="魚群＋SP3（+1⇒戻り）" },
        new structReachPattern{ No= 65, Chusenti=0, Name="魚群＋SP3（+2）" },
        new structReachPattern{ No= 66, Chusenti=0, Name="魚群＋SP3（+3⇒戻り）" }
    };
    ...
    List<structReachPattern> reachPattern4 = new List<structReachPattern>
    {
        new structReachPattern{ No= 1, Chusenti=33500, Name="ノーマル" },
        new structReachPattern{ No= 2, Chusenti=25000, Name="泡+ノーマル" },
        new structReachPattern{ No= 3, Chusenti=0, Name="泡+SP1" },
        new structReachPattern{ No= 4, Chusenti=0, Name="泡+SP2" },
        new structReachPattern{ No= 5, Chusenti=5500, Name="泡+SP3" },
        new structReachPattern{ No= 6, Chusenti=0, Name="魚群+SP1" },
        new structReachPattern{ No= 7, Chusenti=0, Name="魚群+SP2" },
